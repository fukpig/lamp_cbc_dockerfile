...
RUN add-apt-repository -y ppa:ondrej/php && \
  ...
  apt-get update && \
  apt-get -y upgrade && \
  apt-get -y install supervisor wget git apache2 php-xdebug libapache2-mod-php5.6 mysql-server php5.6 php5.6-mysql pwgen php5.6-apc php5.6-mcrypt php5.6-gd php5.6-xml php5.6-mbstring php5.6-soap php5.6-gettext zip unzip php5.6-zip curl php5.6-curl && \
